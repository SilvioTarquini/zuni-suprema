...
const CATALOGO = {
  'os-bastidores-da-mente-1-a-origem-de-todo-bem-e-de-todo-mal': {
    ...
    indicadoPara: 'Para quem reage de um jeito que depois não reconhece como seu, ou quer entender de onde vêm impulsos, raiva e medo antes de tentar controlá-los. Porta de entrada da série.',
  ...
  'os-bastidores-da-mente-2-o-antidoto': {
    ...
    indicadoPara: 'Para quem está em conflito prolongado — familiar, profissional, jurídico — e sente que está endurecendo ou se tornando parecido com aquilo que enfrenta.',
    textoFonteParaLeitura: '/documentos-zuni/os_bastidores_da_mente_base_mentor.txt',
    chatDisponivel: true
  },
  'os-bastidores-da-mente-3-a-bussola-humana': {
    ...
    indicadoPara: 'Para quem vive atrito recorrente de convivência e não entende por que as pessoas ao redor funcionam de forma tão diferente da sua.',
    textoFonteParaLeitura: '/documentos-zuni/os_bastidores_da_mente_base_mentor.txt',
    chatDisponivel: true
  },
  'os-bastidores-da-mente-4-a-travessia': {
    ...
    indicadoPara: 'Para quem chegou a uma estabilidade que já não faz sentido e pergunta para que serve o que está construindo.',
    textoFonteParaLeitura: '/documentos-zuni/os_bastidores_da_mente_base_mentor.txt',
    chatDisponivel: true
  },
  'os-bastidores-da-mente-5-a-escada': {
    ...
    indicadoPara: 'Para quem começou a olhar para trás — heranças de família, padrões que se repetem por gerações — e quer entender o fio que os liga.',
    textoFonteParaLeitura: '/documentos-zuni/os_bastidores_da_mente_base_mentor.txt'
  },
  'os-bastidores-da-mente-6-o-designio': {
    ...
    indicadoPara: 'Para quem já percorreu a série e busca o fechamento: a relação entre a jornada pessoal e algo maior que ela.',
    textoFonteParaLeitura: '/documentos-zuni/os_bastidores_da_mente_base_mentor.txt'
  },
  'arquitetura-excelencia-humana-ii': {
    ...
    indicadoPara: 'Para quem tem exames "normais" mas vive cansado, com névoa mental e sem disposição, e quer entender a causa biológica em vez de tratar sintoma por sintoma.'
  },
  ...
  'codigo-feminino': {
    ...
    indicadoPara: 'Para a mulher que quer um mapa completo do próprio corpo — hormônios, ciclo, sono, pele, sexualidade, menopausa — em linguagem integrativa.',
  ...
  'a-inteligencia-do-corpo-feminino': {
    ...
    indicadoPara: 'Para a mulher com inchaço, retenção, celulite resistente ou cansaço que o sono não resolve, e que já ouviu que é "falta de disciplina".',
  ...
  'inesquecivel-charme-feminino': {
    ...
    indicadoPara: 'Para a mulher que quer se conectar com leveza e valor próprio, sem competir nem representar um papel.',
  ...
  'a-mulher-que-permanece-inteira': {
    ...
    indicadoPara: 'Para a mulher que sai de um vínculo desgastante, ou entra em um novo com receio de se perder de novo. Inclui reconhecimento de padrões emocionais masculinos.',
  ...
  'a-arte-da-presenca-masculina': {
    ...
    indicadoPara: 'Para o homem que sente que precisa performar para ser levado a sério, e quer segurança que não dependa de teatro.',
  ...
  'a-presenca-em-acao-apendice': {
    ...
    indicadoPara: 'Complemento prático de "A Arte da Presença Masculina" — para quem já entendeu o princípio e quer exercício diário. Indicar junto ou depois, nunca sozinho.',
  ...
  'a-arte-invisivel-elegancia-masculina': {
    ...
    indicadoPara: 'Para o homem que quer refinamento que não se compra: postura, voz, olhar, o modo de tratar as pessoas.',
  ...
  'guia-integral-saude-beleza-masculina': {
    ...
    indicadoPara: 'Para o homem com queixa de energia, libido, testosterona, próstata ou desempenho, que quer entender o próprio corpo em profundidade.',
  ...
  'protocolo-90s-executive-black': {
    ...
    indicadoPara: 'Para quem lidera sob pressão e está pagando por isso em sono, saúde ou relações — e quer um sistema de governança pessoal, não técnicas soltas.'
  },
  'executive-black-standalone': {
    ...
    indicadoPara: 'Versão compacta do Protocolo Executive Black, para quem quer aplicação imediata sem o percurso longo sobre liderança e legado. Alternativa, não complemento.'
  },
  'a-arquitetura-da-decisao-humana': {
    ...
    indicadoPara: 'Para quem trava diante de decisões, ou decide e se arrepende, e quer entender o mecanismo por trás da escolha.'
  },
  'a-arte-e-a-ciencia-de-viver': {
    ...
    indicadoPara: 'Para quem sente que a vida virou automatismo e consumo, e busca um percurso amplo — do biológico ao existencial.'
  },
  'a-inteligencia-da-vida': {
    ...
    indicadoPara: 'Para quem não tem diagnóstico mas não se sente saudável, e quer ver o organismo como sistema integrado em vez de peças separadas.'
  },
  'a-jornada-interior': {
    ...
    indicadoPara: 'Para quem foi fragmentado entre especialistas — corpo com um, mente com outro — e quer reunir nutrição, emoção, sono e movimento em um mapa só.'
  },
  'excelencia-humana': {
    ...
    indicadoPara: 'Para quem quer um modelo integrado de saúde, foco, equilíbrio e propósito, sem partir de uma queixa clínica.'
  },
  'o-retorno-da-clareza': {
    ...
    indicadoPara: 'Para quem perdeu a capacidade de sustentar atenção, não termina o que começa e vive em fragmentos de estímulo.'
  },
  'a-neurobiologia-integrativa-da-depressao': {
    ...
    indicadoPara: 'Para quem convive com desânimo persistente e perda de interesse, e quer entender a depressão além do "desequilíbrio químico".'
  },
  'a-visao-integrativa-da-obesidade': {
    ...
    indicadoPara: 'Para quem já tentou várias dietas, recuperou o peso e quer entender por que "comer menos e mover mais" falhou.'
  },
  'medicina-natural-integrativa': {
    ...
    indicadoPara: 'Para quem quer começar pelos fundamentos — água, luz, sono, movimento, nutrição, estresse — antes de qualquer coisa mais complexa.'
  },
  'mentes-esgotadas': {
    ...
    indicadoPara: 'Para quem chega em burnout, ansiedade ou vazio, com a queixa entrando pelo lado mental e emocional.'
  },
  'o-elo-invisivel': {
    ...
    indicadoPara: 'Para quem tem cansaço e névoa mental junto de sinal metabólico — peso, glicemia, intestino, inflamação.'
  },
  'rejuvenesca': {
    titulo: 'Rejuvenesça',
    precoOriginal: 87.90,
    ...
    indicadoPara: 'Para quem sente o corpo mudando com a idade e quer agir sobre idade biológica em vez de aceitar o declínio como inevitável.'
  },
  'transforma-te-protocolos-90s': {
    ...
    indicadoPara: 'Para quem reage no impulso e se arrepende — raiva, pânico, discussão — e quer uma ferramenta para os segundos anteriores à reação.'
  },
  'consequencias-edicao-essencial': {
    ...
    indicadoPara: 'Para quem sabe quais hábitos precisa mudar, adia, e quer ver a que ponto cada adiamento leva — e onde ainda dá para interromper.'
  },
  'alem-do-que-voce-ve': {
    ...
    indicadoPara: 'Para pai, mãe ou responsável de adolescente que virou um estranho em casa — portas batidas, silêncios, namoro. Obra dirigida ao adulto.',
    audiobookPartes: [
  ...
  'alem-do-que-voce-sente': {
    ...
    indicadoPara: 'Obra dirigida ao próprio adolescente, sobre emoções, amizades, namoro e limites. Indicar ao adulto como material para o filho, nunca como leitura do adulto.',
    audiobookPartes: [
  ...
  'o-caminho-da-consciencia': {
    ...
    indicadoPara: 'Para quem busca compreensão de si por uma via esotérica e reflexiva, e quer transformar dor em entendimento.'
  },
  'inteligencia-artificial-volume-1': {
    ...
    indicadoPara: 'Para quem teme ficar para trás com a IA e quer entender os fundamentos antes de aplicar.'
  },
  'empresas-inteligentes-volume-2': {
    ...
    indicadoPara: 'Para quem já decidiu implementar IA no próprio negócio e quer o caminho prático: diagnóstico, processo, automação.'
  },
  'tempo-para-viver': {
