...
const temas = [
  'administracao_empresarial_inteligente',
  'obesidade',
  'depressao',
...
const mensagensTestePorTema = {
  administracao_empresarial_inteligente: 'Tenho dificuldade em tomar decisões importantes sob pressão e me sinto constantemente "ligado", sem conseguir desligar do trabalho. Como posso melhorar isso?',
  obesidade: 'Tenho dificuldade em manter uma rotina de alimentação saudável e compulsão alimentar frequente. O que fazer?',
  depressao: 'Me sinto constantemente cansado e sem energia, perdi o interesse no que antes gostava. Isso já dura meses. Como posso lidar?',
...
async function rodarTodosTestes() {
  console.log('\n🚀 INICIANDO TESTES DE RAG HÍBRIDO\n');
